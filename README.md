...
- Modeling Examples
  ...
  - [A 2D Cardiac Electrophysiology Model (CUDA-accelerated PDE solver)](http://nbviewer.jupyter.org/github/siravan/DiffEqTutorials.jl/blob/master/PhysicalModels/BeelerReuter2D_IMEX_CUDA.ipynb)
- Extra ODE Features
